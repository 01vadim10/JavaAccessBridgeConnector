...
namespace LeapTest.JavaController.Common.AccessBridgeInterop
{
    /// <summary>
    ...
    internal partial class AccessBridgeNativeFunctions : AccessBridgeFunctions
    {
        ...
        public override bool ActivateAccessibleHyperlink(int vmid, JavaObjectHandle accessibleContext,
            JavaObjectHandle accessibleHyperlink)
        {
            var result = EntryPoints.ActivateAccessibleHyperlink(vmid, Unwrap(vmid, accessibleContext),
                Unwrap(vmid, accessibleHyperlink));
        ...
        public override bool DoAccessibleActions(int vmid, JavaObjectHandle accessibleContext,
            ref AccessibleActionsToDo actionsToDo, out int failure)
        {
            var result =
                EntryPoints.DoAccessibleActions(vmid, Unwrap(vmid, accessibleContext), ref actionsToDo, out failure);
            GC.KeepAlive(accessibleContext);
            return Succeeded(result);
        }

        public override bool GetAccessibleActions(int vmid, JavaObjectHandle accessibleContext,
            out AccessibleActions actions)
        {
        ...
        public override bool GetAccessibleContextAt(int vmid, JavaObjectHandle acParent, int x, int y,
            out JavaObjectHandle ac)
        {
            JOBJECT64 acTemp;
        ...
        public override bool GetAccessibleHyperlink(int vmid, JavaObjectHandle hypertext, int nIndex,
            out AccessibleHyperlinkInfo hyperlinkInfo)
        {
            AccessibleHyperlinkInfoNative hyperlinkInfoTemp;
            var result =
                EntryPoints.GetAccessibleHyperlink(vmid, Unwrap(vmid, hypertext), nIndex, out hyperlinkInfoTemp);
        ...
        public override bool GetAccessibleHypertext(int vmid, JavaObjectHandle accessibleContext,
            out AccessibleHypertextInfo hypertextInfo)
        {
            AccessibleHypertextInfoNative hypertextInfoTemp;
            var result =
                EntryPoints.GetAccessibleHypertext(vmid, Unwrap(vmid, accessibleContext), out hypertextInfoTemp);
            GC.KeepAlive(accessibleContext);
            if (Succeeded(result))
        ...
        public override bool GetAccessibleHypertextExt(int vmid, JavaObjectHandle accessibleContext, int nStartIndex,
            out AccessibleHypertextInfo hypertextInfo)
        {
            AccessibleHypertextInfoNative hypertextInfoTemp;
            var result = EntryPoints.GetAccessibleHypertextExt(vmid, Unwrap(vmid, accessibleContext), nStartIndex,
                out hypertextInfoTemp);
            GC.KeepAlive(accessibleContext);
            if (Succeeded(result))
                hypertextInfo = Wrap(vmid, hypertextInfoTemp);
            else
        ...
        public override bool GetAccessibleKeyBindings(int vmid, JavaObjectHandle accessibleContext,
            out AccessibleKeyBindings keyBindings)
        {
        ...
        public override bool GetAccessibleRelationSet(int vmid, JavaObjectHandle accessibleContext,
            out AccessibleRelationSetInfo relationSetInfo)
        {
            AccessibleRelationSetInfoNative relationSetInfoTemp;
            var result =
                EntryPoints.GetAccessibleRelationSet(vmid, Unwrap(vmid, accessibleContext), out relationSetInfoTemp);
            GC.KeepAlive(accessibleContext);
            if (Succeeded(result))
        ...
        public override bool GetAccessibleTableCellInfo(int vmid, JavaObjectHandle at, int row, int column,
        ...
        public override JavaObjectHandle GetAccessibleTableColumnDescription(int vmid, JavaObjectHandle acParent,
            int column)
        {
        ...
        public override bool GetAccessibleTableColumnHeader(int vmid, JavaObjectHandle acParent,
            out AccessibleTableInfo tableInfo)
        {
        ...
        public override bool GetAccessibleTableColumnSelections(int vmid, JavaObjectHandle table, int count,
            [Out] int[] selections)
        {
        ...
        public override bool GetAccessibleTableRowHeader(int vmid, JavaObjectHandle acParent,
            out AccessibleTableInfo tableInfo)
        {
            AccessibleTableInfoNative tableInfoTemp = new AccessibleTableInfoNative();
        ...
        public override bool GetAccessibleTableRowSelections(int vmid, JavaObjectHandle table, int count,
            [Out] int[] selections)
        {
        ...
        public override bool GetAccessibleTextAttributes(int vmid, JavaObjectHandle at, int index,
        ...
        public override bool GetAccessibleTextInfo(int vmid, JavaObjectHandle at, out AccessibleTextInfo textInfo,
            int x, int y)
        {
        ...
        public override bool GetAccessibleTextItems(int vmid, JavaObjectHandle at,
            out AccessibleTextItemsInfo textItems, int index)
        {
        ...
        public override bool GetAccessibleTextLineBounds(int vmid, JavaObjectHandle at, int index, out int startIndex,
            out int endIndex)
        {
            var result =
                EntryPoints.GetAccessibleTextLineBounds(vmid, Unwrap(vmid, at), index, out startIndex, out endIndex);
            GC.KeepAlive(at);
            return Succeeded(result);
        }

        public override bool GetAccessibleTextRange(int vmid, JavaObjectHandle at, int start, int end,
            [Out] char[] text, short len)
        {
        ...
        public override bool GetAccessibleTextRect(int vmid, JavaObjectHandle at, out AccessibleTextRectInfo rectInfo,
            int index)
        {
        ...
        public override bool GetAccessibleTextSelectionInfo(int vmid, JavaObjectHandle at,
            out AccessibleTextSelectionInfo textSelection)
        {
        ...
        public override bool GetCaretLocation(int vmid, JavaObjectHandle ac, out AccessibleTextRectInfo rectInfo,
            int index)
        {
        ...
        public override bool GetCurrentAccessibleValueFromContext(int vmid, JavaObjectHandle av, StringBuilder value,
            short len)
        {
        ...
        public override bool GetMaximumAccessibleValueFromContext(int vmid, JavaObjectHandle av, StringBuilder value,
            short len)
        {
        ...
        public override bool GetMinimumAccessibleValueFromContext(int vmid, JavaObjectHandle av, StringBuilder value,
            short len)
        {
        ...
        public override bool GetTextAttributesInRange(int vmid, JavaObjectHandle accessibleContext, int startIndex,
            int endIndex, out AccessibleTextAttributesInfo attributes, out short len)
        {
            attributes = new AccessibleTextAttributesInfo();
            var result = EntryPoints.GetTextAttributesInRange(vmid, Unwrap(vmid, accessibleContext), startIndex,
                endIndex, attributes, out len);
            GC.KeepAlive(accessibleContext);
            return Succeeded(result);
        }
        ...
        public override bool GetVisibleChildren(int vmid, JavaObjectHandle accessibleContext, int startIndex,
            out VisibleChildrenInfo children)
        {
            VisibleChildrenInfoNative childrenTemp;
            var result =
                EntryPoints.GetVisibleChildren(vmid, Unwrap(vmid, accessibleContext), startIndex, out childrenTemp);
            GC.KeepAlive(accessibleContext);
            if (Succeeded(result))
    ...
    internal partial class AccessBridgeNativeEvents : AccessBridgeEvents
    {
        ...
        private AccessBridgeEntryPoints.PopupMenuWillBecomeInvisibleEventHandler
            _forwardPopupMenuWillBecomeInvisibleKeepAlive;

        private AccessBridgeEntryPoints.PopupMenuWillBecomeVisibleEventHandler
            _forwardPopupMenuWillBecomeVisibleKeepAlive;

        private AccessBridgeEntryPoints.PropertyActiveDescendentChangeEventHandler
            _forwardPropertyActiveDescendentChangeKeepAlive;
        ...
        private AccessBridgeEntryPoints.PropertyDescriptionChangeEventHandler
            _forwardPropertyDescriptionChangeKeepAlive;
        ...
        private AccessBridgeEntryPoints.PropertyVisibleDataChangeEventHandler
            _forwardPropertyVisibleDataChangeKeepAlive;
        ...
        protected virtual void OnPropertyActiveDescendentChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
            JavaObjectHandle oldActiveDescendent, JavaObjectHandle newActiveDescendent)
        {
        ...
        protected virtual void OnPropertyCaretChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
        ...
        protected virtual void OnPropertyChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
        ...
        protected virtual void OnPropertyChildChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
            JavaObjectHandle oldChild, JavaObjectHandle newChild)
        {
        ...
        protected virtual void OnPropertyDescriptionChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
        ...
        protected virtual void OnPropertyNameChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
        ...
        protected virtual void OnPropertyStateChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
        ...
        protected virtual void OnPropertyTableModelChange(int vmid, JavaObjectHandle evt, JavaObjectHandle src,
        ...
        protected virtual void OnPropertyValueChange(int vmid, JavaObjectHandle evt, JavaObjectHandle source,
            string oldValue, string newValue)
        {
        ...
        private void ForwardPropertyActiveDescendentChange(int vmid, JOBJECT64 evt, JOBJECT64 source,
            JOBJECT64 oldActiveDescendent, JOBJECT64 newActiveDescendent)
        {
            OnPropertyActiveDescendentChange(vmid, Wrap(vmid, evt), Wrap(vmid, source), Wrap(vmid, oldActiveDescendent),
                Wrap(vmid, newActiveDescendent));
        }

        private void ForwardPropertyCaretChange(int vmid, JOBJECT64 evt, JOBJECT64 source, int oldPosition,
            int newPosition)
        {
            OnPropertyCaretChange(vmid, Wrap(vmid, evt), Wrap(vmid, source), oldPosition, newPosition);
        }

        private void ForwardPropertyChange(int vmid, JOBJECT64 evt, JOBJECT64 source,
            [MarshalAs(UnmanagedType.LPWStr)] string property, [MarshalAs(UnmanagedType.LPWStr)] string oldValue,
        ...
        private void ForwardPropertyChildChange(int vmid, JOBJECT64 evt, JOBJECT64 source, JOBJECT64 oldChild,
            JOBJECT64 newChild)
        {
            OnPropertyChildChange(vmid, Wrap(vmid, evt), Wrap(vmid, source), Wrap(vmid, oldChild),
                Wrap(vmid, newChild));
        }

        private void ForwardPropertyDescriptionChange(int vmid, JOBJECT64 evt, JOBJECT64 source,
        ...
        private void ForwardPropertyNameChange(int vmid, JOBJECT64 evt, JOBJECT64 source,
        ...
        private void ForwardPropertyStateChange(int vmid, JOBJECT64 evt, JOBJECT64 source,
        ...
        private void ForwardPropertyTableModelChange(int vmid, JOBJECT64 evt, JOBJECT64 src,
        ...
        private void ForwardPropertyValueChange(int vmid, JOBJECT64 evt, JOBJECT64 source,
            [MarshalAs(UnmanagedType.LPWStr)] string oldValue, [MarshalAs(UnmanagedType.LPWStr)] string newValue)
        {
    ...
    internal class AccessBridgeEntryPoints
    {
        ...
        public delegate BOOL ActivateAccessibleHyperlinkFP(int vmid, JOBJECT64 accessibleContext,
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL DoAccessibleActionsFP(int vmid, JOBJECT64 accessibleContext,
            ref AccessibleActionsToDo actionsToDo, out int failure);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleActionsFP(int vmid, JOBJECT64 accessibleContext,
            [Out] AccessibleActions actions);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleHyperlinkFP(int vmid, JOBJECT64 hypertext, int nIndex,
            out AccessibleHyperlinkInfoNative hyperlinkInfo);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate int GetAccessibleHyperlinkCountFP(int vmid, JOBJECT64 accessibleContext);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleHypertextFP(int vmid, JOBJECT64 accessibleContext,
            out AccessibleHypertextInfoNative hypertextInfo);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleHypertextExtFP(int vmid, JOBJECT64 accessibleContext, int nStartIndex,
            out AccessibleHypertextInfoNative hypertextInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleKeyBindingsFP(int vmid, JOBJECT64 accessibleContext,
            out AccessibleKeyBindings keyBindings);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleRelationSetFP(int vmid, JOBJECT64 accessibleContext,
            out AccessibleRelationSetInfoNative relationSetInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTableCellInfoFP(int vmid, JOBJECT64 at, int row, int column,
            [Out] AccessibleTableCellInfoNative tableCellInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTableColumnHeaderFP(int vmid, JOBJECT64 acParent,
            [Out] AccessibleTableInfoNative tableInfo);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate int GetAccessibleTableColumnSelectionCountFP(int vmid, JOBJECT64 table);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTableColumnSelectionsFP(int vmid, JOBJECT64 table, int count,
        ...
        public delegate BOOL
            GetAccessibleTableInfoFP(int vmid, JOBJECT64 ac, [Out] AccessibleTableInfoNative tableInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTableRowHeaderFP(int vmid, JOBJECT64 acParent,
            [Out] AccessibleTableInfoNative tableInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTableRowSelectionsFP(int vmid, JOBJECT64 table, int count,
            [Out] [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)]
            int[] selections);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTextAttributesFP(int vmid, JOBJECT64 at, int index,
            [Out] AccessibleTextAttributesInfo attributes);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTextInfoFP(int vmid, JOBJECT64 at, out AccessibleTextInfo textInfo, int x,
            int y);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTextItemsFP(int vmid, JOBJECT64 at, out AccessibleTextItemsInfo textItems,
            int index);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTextLineBoundsFP(int vmid, JOBJECT64 at, int index, out int startIndex,
            out int endIndex);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTextRangeFP(int vmid, JOBJECT64 at, int start, int end, [Out] char[] text,
            short len);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTextRectFP(int vmid, JOBJECT64 at, out AccessibleTextRectInfo rectInfo,
            int index);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetAccessibleTextSelectionInfoFP(int vmid, JOBJECT64 at,
            out AccessibleTextSelectionInfo textSelection);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetCurrentAccessibleValueFromContextFP(int vmid, JOBJECT64 av, StringBuilder value,
            short len);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetMaximumAccessibleValueFromContextFP(int vmid, JOBJECT64 av, StringBuilder value,
            short len);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetMinimumAccessibleValueFromContextFP(int vmid, JOBJECT64 av, StringBuilder value,
            short len);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate JOBJECT64 GetParentWithRoleFP(int vmid, JOBJECT64 ac,
            [MarshalAs(UnmanagedType.LPWStr)] string role);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate JOBJECT64 GetParentWithRoleElseRootFP(int vmid, JOBJECT64 ac,
            [MarshalAs(UnmanagedType.LPWStr)] string role);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetTextAttributesInRangeFP(int vmid, JOBJECT64 accessibleContext, int startIndex,
            int endIndex, [Out] AccessibleTextAttributesInfo attributes, out short len);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate BOOL GetVisibleChildrenFP(int vmid, JOBJECT64 accessibleContext, int startIndex,
            out VisibleChildrenInfoNative children);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyActiveDescendentChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source,
            JOBJECT64 oldActiveDescendent, JOBJECT64 newActiveDescendent);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyCaretChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source, int oldPosition,
            int newPosition);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source,
            [MarshalAs(UnmanagedType.LPWStr)] string property, [MarshalAs(UnmanagedType.LPWStr)] string oldValue,
            [MarshalAs(UnmanagedType.LPWStr)] string newValue);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyChildChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source,
            JOBJECT64 oldChild, JOBJECT64 newChild);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyDescriptionChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source,
            [MarshalAs(UnmanagedType.LPWStr)] string oldDescription,
            [MarshalAs(UnmanagedType.LPWStr)] string newDescription);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyNameChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source,
            [MarshalAs(UnmanagedType.LPWStr)] string oldName, [MarshalAs(UnmanagedType.LPWStr)] string newName);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyStateChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source,
            [MarshalAs(UnmanagedType.LPWStr)] string oldState, [MarshalAs(UnmanagedType.LPWStr)] string newState);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyTableModelChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 src,
            [MarshalAs(UnmanagedType.LPWStr)] string oldValue, [MarshalAs(UnmanagedType.LPWStr)] string newValue);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public delegate void PropertyValueChangeEventHandler(int vmid, JOBJECT64 evt, JOBJECT64 source,
            [MarshalAs(UnmanagedType.LPWStr)] string oldValue, [MarshalAs(UnmanagedType.LPWStr)] string newValue);
